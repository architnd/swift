...
progressUpdate(steps: 3500, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let projectedTime = totalDistance / currentDistance * currentTime
...
pacing(currentDistance: 1.0, totalDistance: 5.0, currentTime: 11.0, goalTime: 25.0)
/*:
