...
var archit = User(name: "Archit", age: 21, height: 1.76, weight: 65, activityLevel: 7)
print("User Description: ")
print("name: \(archit.name)")
print("age: \(archit.age)")
print("height: \(archit.height)")
print("weight: \(archit.weight)")
print("activityLevel: \(archit.activityLevel)")
/*:
