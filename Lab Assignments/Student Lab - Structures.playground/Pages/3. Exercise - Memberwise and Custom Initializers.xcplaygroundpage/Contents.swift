...
let favoriteBook = Book(title: "1984", author: "George Orwell", pages: 328, price: 7.99)
...
let laptop1 = Laptop(yearPurchased: 2025)
let laptop2 = Laptop(repairCount: 1, yearPurchased: 2026)
/*:
...
var myHeight = Height(heightInCentimeters: 176)
