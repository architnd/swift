...
let familyAndFriends = ["A", "B", "D", "E", "C"]
let sortedCollection1 = familyAndFriends.sorted(by: forwards)
...
let sortedCollection2 = familyAndFriends.sorted(by: { (name1: String, name2: String) -> Bool in
    return name1 < name2
})
...
let sortedCollection3 = familyAndFriends.sorted(by: { $0 < $1 })
