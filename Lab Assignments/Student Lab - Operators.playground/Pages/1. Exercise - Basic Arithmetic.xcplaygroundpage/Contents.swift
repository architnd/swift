...
print("I think Integer division of 10 by 3 will be 3,actual answer:")
...
print("This value is different from integer division as it is giving a more accurate decimal value.")
/*:
...
print(even % 2)
print(odd % 2)
print("We can determine if a number is odd or even by calculating the remainder whne dividing the value by 2, if it is 0 number is even, else the number is odd.")
/*:
