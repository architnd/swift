...
//print(falcon.weapon)
print("A base class cannot use the properties of an inherited class because it exists independently and has no knowledge of which classes inherit from it or what properties they might add.")
