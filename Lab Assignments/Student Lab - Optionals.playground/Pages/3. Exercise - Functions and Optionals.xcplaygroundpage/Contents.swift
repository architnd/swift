...
if let itemCost = itemCost(item: "Juice") {
    print(itemCost)
}
/*:
[Previous](@previous)  |  page 3 of 6  |  [Next: App Excercise - Food Functions](@next)
 */
